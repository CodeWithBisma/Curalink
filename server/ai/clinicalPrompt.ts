...
1. Extract chief complaint, duration, location, severity, associated symptoms, and denied symptoms directly from patient statements.
2. DO NOT turn symptoms into diagnoses! If the doctor does NOT state a diagnosis in the dialogue, doctor_stated_diagnosis and doctor_stated_assessment MUST be "Not documented", and icd10_code MUST be "Not documented".
3. NEVER output Cephalalgia or any other ICD-10 diagnosis unless the doctor explicitly stated that diagnosis.
4. If something was not discussed or tested (e.g. physical exam, vitals, allergies, doctor advice, red flags, treatment plan), record it as "Not documented" (or "No physical examination findings documented in the provided transcript.").
5. DO NOT invent doctor advice or emergency warnings. If unspoken by the doctor, mark as "Not documented".
6. In ai_safety_considerations, provide relevant safety observations strictly labeled "AI-generated safety consideration — clinician review required".
7. Return strictly valid JSON adhering to the response schema.`;
