      ...
      <header className="sticky top-0 z-40 bg-white border-b border-[#E5E7EB]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-5 xl:gap-7 text-sm font-medium">
            ...
            {/* Home Visit (Nurse & Paramedic) - Direct, High-Visibility Link */}
            <button 
              id="nav-homecare"
              onClick={() => handleNav('/home-care')} 
              className={`transition-colors cursor-pointer flex items-center gap-1.5 py-1.5 px-2.5 rounded-lg border ${
                currentPath.startsWith('/home-care') || currentPath.startsWith('/home-visit') || currentPath === '/nurses'
                  ? 'bg-teal-50 border-teal-300 text-[#0F766E] font-bold shadow-2xs'
                  : 'border-transparent text-gray-700 hover:text-[#0F766E] hover:bg-gray-50'
              }`}
            >
