...
export const EmergencyModal: React.FC<EmergencyModalProps> = ({
  ...
  patientLocation = 'DHA Phase 5, Lahore',
  ...
  const tertiaryHospitals = [
    { name: 'Rescue 1122 Punjab / Sindh / KPK / Islamabad', tel: '1122', note: 'National Toll-Free EMS Ambulance' },
    { name: 'Edhi Foundation Ambulance Service', tel: '115', note: 'Rapid 24/7 Citywide Transport' },
    { name: 'Chhipa Emergency Ambulance', tel: '1020', note: 'Urban Emergency Response' },
    { name: 'National Hospital & Medical Centre ER (Lahore)', tel: '+9242111171819', note: 'Cardiac & Trauma 24/7 ER' },
    { name: 'Aga Khan University Hospital Emergency (Karachi)', tel: '+922134930051', note: 'Level 1 Trauma & Resus' },
    { name: 'Shifa International Hospital Emergency (Islamabad)', tel: '+92518464646', note: 'Tertiary Emergency Centre' }
  ];
